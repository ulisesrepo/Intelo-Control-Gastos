						...
						<form id="form_empleados" >
							<div class="form-row">
								<div class="form-group col-md-6">
									...
									<input type="text" class="form-control required" id="nombre" name="nombre" minlength="3" pattern="[a-z]">
								</div>
								<div class="form-group col-md-6">
									<label for="apellidos">Apellidos</label>
									<input type="text" class="form-control required" id="apellidos" name="apellidos" minlength="3">
								</div>
							</div>
							<div class="form-row">
								<div class="form-group col-md-12">
									<label for="email">E-mail:</label>
									<input type="email" class="form-control required email" id="email" name="email"  minlength="3">
								</div>
							</div>
							<div class="form-row">
								<div class="form-group col-md-6">
